...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lstAuthors.setGeometry(QtCore.QRect(30, 60, 651, 192))
        font = QtGui.QFont()
        ...
        self.lstTitles.setGeometry(QtCore.QRect(30, 310, 661, 192))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lstTitles.setFont(font)
        self.lstTitles.setObjectName("lstTitles")
        self.lblTitles = QtWidgets.QLabel(Form)
        self.lblTitles.setGeometry(QtCore.QRect(40, 270, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
