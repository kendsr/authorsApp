...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lstAuthors.setGeometry(QtCore.QRect(30, 60, 271, 192))
        font = QtGui.QFont()
        ...
        self.lstTitles.setGeometry(QtCore.QRect(340, 60, 441, 192))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lstTitles.setFont(font)
        self.lstTitles.setObjectName("lstTitles")
        self.lblTitles = QtWidgets.QLabel(Form)
        self.lblTitles.setGeometry(QtCore.QRect(350, 20, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
